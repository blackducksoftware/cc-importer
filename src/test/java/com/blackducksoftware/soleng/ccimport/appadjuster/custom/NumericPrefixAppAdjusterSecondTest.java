...
public class NumericPrefixAppAdjusterSecondTest {
	...
	public void test() throws Exception {
		...
		props.setProperty("numprefixed.app.name.format.without.description", "[0-9][0-9][0-9]+-(PROD|RC1|RC2|RC3|RC4|RC5)-CURRENT");
		props.setProperty("numprefixed.app.name.format.with.description", "[0-9][0-9][0-9]+-.*-(PROD|RC1|RC2|RC3|RC4|RC5)-CURRENT");
		props.setProperty("numprefixed.appname.pattern.follows.description", "-(PROD|RC1|RC2|RC3|RC4|RC5)-CURRENT");
		...
		metadata = adjuster.parse("25776-RDT-Static Data Maintenance (SDM)-PROD-CURRENT");
		assertEquals("25776", metadata.getNumericPrefix());
		assertEquals("RDT-Static Data Maintenance (SDM)", metadata.getAppNameString());
		assertEquals("PROD", metadata.getWorkStream());
